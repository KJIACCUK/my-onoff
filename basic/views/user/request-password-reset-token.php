...
<div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-offset-3 bor10 m-t-50 m-b-70 p-t-20 p-b-20 p-l-20 p-r-20">
                    ...
                    <?= $form->field($model, 'email')->textInput(['placeholder'=>'Введите адрес почты']) ?>
                    <div class="form-group col-sm-4">
                        <?= Html::submitButton('Отправить', ['class' => 'flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer']) ?>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
