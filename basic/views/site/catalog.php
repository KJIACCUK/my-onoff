    ...
    <div class="container">
        <div class="row isotope-grid">
            <?php foreach ($subsection as $section):?>
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto isotope-item <?=$section->sections_id?>">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="/images/subsection/catalog.jpg" alt="IMG-BANNER">

                        <a href="<?=Url::toRoute(['catalog-subsection', 'id'=>$section->id])?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
