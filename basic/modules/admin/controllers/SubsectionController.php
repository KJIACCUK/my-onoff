...
use app\modules\admin\models\Subsection;
...
class SubsectionController extends Controller
{
    ...
    private function saveImage($model){
        ...
        if(!empty($file)) {
            ...
            $file->saveAs(Yii::getAlias('@web') . 'images/subsection/' . $name_img);
    ...
    public function actionDelete($id)
    {
        ...
        if(!empty($search->img)){
            unlink(Yii::getAlias('@web') . 'images/subsection/' . $search->img);
        }
